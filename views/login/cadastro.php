...
<div class="div_cadastro" style="padding: 10px; padding-left: 70px; padding-right: 70px;">
<div style="text-align: center;"> 
	<h3>Faça seu Cadastro</h3><br>
	<form method="POST" action="../../controllers/CadastraUsuario.php">
  	<div class="form-row">
		...
		<div class="form-group col-md-6">
			...
			<input type="text" class="form-control" name="user_lastname" id="user_lastname" placeholder="Últimos Nomes">
		</div>

		<div class="form-group col-md-6">
			<label>Aniversário</label>
			<input type="date" class="form-control" name="user_bday" id="user_bday" >
		</div>
		...
		<div class="col-12">
			<ul style="float: center;">
				<input type="submit" class="button alt" value="Cadastre-se"/>
			</ul>
		</div>
