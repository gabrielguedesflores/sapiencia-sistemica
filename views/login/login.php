...
<div class="col-4 col-12-narrower" style="text-align:center;">
								<div id="sidebar">
									...
									<!-- Sidebar -->
										...
										<section>
											...
											<p><?php echo $_SESSION["login"]->user_name;?>, primeiro saia da sua conta, para depois cadastrar uma nova. Use os botões abaixo para navegar no site.</p><BR>
											<ul class="links">
                                            	<li><button class="button alt">Volte ao início</button></li>
                                            </ul>
...
<div class="div_login" style="padding: 10px; padding-left: 70px; padding-right: 70px;">
	<h3>&nbsp;&nbsp;Faça o Login</h3><br>
	<form method="POST" action="../../controllers/VerificaLogin.php">

		<div class="form-row">
			<?php if(isset($_SESSION["update_senha_success"])){
				session_start();
				$message = $_SESSION["update_senha_success"];
				echo $message; }
				?>
			...
			<a href="redefine_senha.php">Esqueci minha senha</a>
			<div class="col-12">
			<br>
