...
<br>
<div class="div_insere_nova_senha" style="padding: 10px; padding-left: 70px; padding-right: 70px; text-align: center;">
	<h3>&nbsp;&nbsp;Preencha os dados para redefinir a senha</h3><br>

	<form method="POST" action="../../controllers/UpdateSenha.php">
		...
		<div class="form-row">
            ...
            <div class="form-group col-md-6">
  				<input type="password" class="form-control" name="new_pass" id="new_pass" placeholder="Sua nova senha" required>
			</div>
            <div class="form-group col-md-6">
  				<input type="password" class="form-control" name="new_pass_again" id="new_pass_again" placeholder="Sua nova senha novamente" required>
			</div>
			
			
			<div class="col-12">
			<br>
				<input type="submit" class="button alt" value="Redefinir Senha"/>
			</div>
...
<section id="cta" class="wrapper style3">
		...
		<!-- Scripts -->
			...
			<script>
				<?php if(isset($_SESSION["UpdateSenha"])){?>
