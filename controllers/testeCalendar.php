...
class Calendar{
    ...
    public function GetNomeMes($mes){
        ...
        $meses = array( '01' => "Janeiro", '02' => "Fevereiro", '03' => "Mar̤o",
    ...
    public function MostreCalendario($mes){
        ...
        $numero_dias = $this->GetNumeroDias($mes);	// retorna o n̼mero de dias que tem o m̻s desejado
        ...
        $this->MostreSemanas();	// fun̤̣o que mostra as semanas aqui
            ...
            for( $coluna = 0; $coluna < 7; $coluna++ ){
                ...
                if($diacorrente + 1 <= $numero_dias){
                    ...
                    if($coluna < $diasemana && $linha == 0){
                        ...
                        //echo "<a href = ?pagina=mes$mes-".($diacorrente+1)."'>".++$diacorrente . "</a>";
...
/*
...

    {
        ...
        $tagOptionIni = "<label for='M̻s'>Escolha o M̻s:</label>
